...
public class Teste3Application implements CommandLineRunner{
	...
	public void run(String...args)throws Exception{
		...
		cat2.getProdutos().addAll(Arrays.asList(p2,p4,p6));
		...
		Cliente cliente= new Cliente(null,"Gabriel","gg@gg.com","431.578.448-65",TipoCliente.PESSOAFISICA);
		...
		prod_repo.saveAll(Arrays.asList(p1,p2));
